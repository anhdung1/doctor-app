import 'package:app/layers/presentation/blocs/authentication/login_bloc/login_bloc.dart';
import 'package:app/layers/presentation/views/doctor/home_doctor.dart';

import 'package:app/layers/presentation/views/user/my_home.dart';
import 'package:app/layers/presentation/views/auth/signup.dart';
import 'package:app/layers/presentation/views/constants/variable.dart';
import 'package:app/layers/presentation/views/widgets/auth.dart';
    ...
    return Scaffold(
      body: BlocConsumer<LoginBloc, LoginState>(
        builder: (context, state) {
          if (state is LoginMoveSigupState) {
            return const Signup();
          }
